...
<!--Logout ends-->
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <form>
            <button type="button" id="b1" class="btn btn-primary btn-lg btn-block">Open Customer Account</button>
          </form><br>
         <form action="">
        ...
        <br><br>       
            <div class="col-lg-6">
                <form action="">
                    <button type="button" id="b3" onclick="" class="btn btn-success btn-lg btn-block">View Customer Account Details</button>
                </form><br/>
              <form action=""><button type="button" id="b4" class="btn btn-warning btn-lg btn-block">View Customer Transaction Details</button></form>
            </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
 ...
 <script>document.getElementById("b1").onclick = function () {
