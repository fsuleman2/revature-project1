                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="deposit" class="form-control" placeholder="Enter Your Deposit Amount" required>
                                </div>
                            </div>
            ...
            <div id="results" class="container"> -->
                ...
                <script>
                    btn1.onclick = () => {
                        ...
                        alert("Amount " + document.getElementById("deposit").value + " Successfully Inserted into your Account");
