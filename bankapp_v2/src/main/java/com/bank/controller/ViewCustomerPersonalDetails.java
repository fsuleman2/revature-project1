...
/**
 * Servlet implementation class ViewCustomerPersonalDetails
 */
 @WebServlet("/viewcustomerdetails")
public class ViewCustomerPersonalDetails extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(ViewCustomerPersonalDetails.class);
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewCustomerPersonalDetails() {
        super();
